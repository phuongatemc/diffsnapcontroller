...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChangedBlockStatus) DeepCopyInto(out *ChangedBlockStatus) {
	*out = *in
	if in.Context != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChangedBlockStatus.
func (in *ChangedBlockStatus) DeepCopy() *ChangedBlockStatus {
	if in == nil {
		return nil
	}
	out := new(ChangedBlockStatus)
	in.DeepCopyInto(out)
	return out
}

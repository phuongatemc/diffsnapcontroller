	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DifferentialsnapshotV1alpha1().VolumeSnapshotDeltas(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DifferentialsnapshotV1alpha1().VolumeSnapshotDeltas(namespace).Watch(context.TODO(), options)
			},
		},
		&differentialsnapshotv1alpha1.VolumeSnapshotDelta{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *volumeSnapshotDeltaInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&differentialsnapshotv1alpha1.VolumeSnapshotDelta{}, f.defaultInformer)
}

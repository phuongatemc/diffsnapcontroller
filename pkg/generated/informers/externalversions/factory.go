...
type SharedInformerFactory interface {
	...
	Differentialsnapshot() differentialsnapshot.Interface
}

func (f *sharedInformerFactory) Differentialsnapshot() differentialsnapshot.Interface {
	return differentialsnapshot.New(f, f.namespace, f.tweakListOptions)
}
